...
class _StopwatchModalState extends State<StopwatchModal>
  ...
  List<DropdownMenuItem<int>> _buildTopicDropdownItems(
    List<Topic> topics, {
    int level = 0,
  }) {
    ...
    for (var topic in topics) {
      ...
      if (isGroupingTopic) {
        items.addAll(
          _buildTopicDropdownItems(topic.sub_topics!, level: level + 1),
        );
      }
    }
    return items;
            ...
            children: [
                ...
                children: [
                        ...
                        children: [
                          Expanded(
                            child: NumberPickerWheel(
                              ...
                              maxValue: 23,
                              initialValue:
                                  stopwatchProvider.timerDuration.inHours,
                              onChanged: (value) {
                                final current =
                                    stopwatchProvider.timerDuration;
                  ...
                  Column(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () =>
                            stopwatchProvider.toggleMode(false),
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 16.0),
                  if (stopwatchProvider.stopwatch.elapsed.inMilliseconds >
                      0)
                    IconButton(
                      iconSize: 56.0,
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      // Reseta o provider IMEDIATAMENTE para que o botão flutuante
                      // já apareça com o estado inicial durante a animação de volta
